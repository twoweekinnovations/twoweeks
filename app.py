...
PRODUCTS = [
    {"id": 1, "name": "AirPods Pro 2", "price": 169.00, "description": "Active Noise Cancellation and Transparency mode", "available": True},
    {"id": 2, "name": "AirPods Max", "price": 399.00, "description": "High-fidelity audio with Active Noise Cancellation", "available": True},
    {"id": 3, "name": "AirPods 4 ANC", "price": None, "description": "Coming soon - Next generation AirPods with ANC", "available": False},
    {"id": 4, "name": "Apple Lightning Cable", "price": None, "description": "Coming soon - Official Apple Lightning Cable", "available": False},
    {"id": 5, "name": "Apple Watch SE", "price": None, "description": "Coming soon - The affordable Apple Watch option", "available": False}
]
